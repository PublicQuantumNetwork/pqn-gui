...
export const PageRedirectContext = createContext<
  PageRedirectContextType | undefined
>(undefined);

export const PageRedirectProvider = ({
  children,
}: PageRedirectProviderProps) => {
...
export const usePageRedirect = () => {
  ...
  if (context === undefined) {
    throw new Error(
      'usePageRedirect must be used within a PageRedirectProvider'
    );
  }
  return context;
};
