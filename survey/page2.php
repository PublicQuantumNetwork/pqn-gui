...
$sql = "SELECT id, question, option1, option2, option3, option4 FROM survey_questions WHERE question_order = :question_order";
$st = $conn->prepare($sql);
...
echo show_survey_questions_answers($strip_page_name, 4, $question_id, $question, $option1, $option2, $option3, $option4, "", "","", "");
