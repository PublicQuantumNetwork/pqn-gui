...
<div class="u-clearfix speech-bubble-wrapper">
	<div class="fleft speech-bubble" style="padding:10%;">
		<?= $question ?>
	</div>
</div>
...
<div class="u-clearfix right-side-wrapper" style="margin-left:1100px; margin-top:200px;">
	...
	<div style="position:absolute; margin-left:100px; margin-top:360px;">
		<input type="hidden" name="txtNextPage" id="txtNextPage" value="page6.php">
		<input type="hidden" name="txtQuestionOrder" id="txtQuestionOrder" value="5">
		<input type="hidden" name="txtDegree" id="txtDegree" value="90">
		<input type="hidden" name="txtQuestionID" id="txtQuestionID" value="4">
